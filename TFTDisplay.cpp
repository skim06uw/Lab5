...
void printAccelValues(void* displayData) {
    ...
    *****************/
    ...
    if ( *(accelValues->displayAccelFlag) ) {
        printAccelValues_Helper(data->tftDisplay, accelValues->xRelPosition, 0);
        printAccelValues_Helper(data->tftDisplay, accelValues->yRelPosition, 1);
        printAccelValues_Helper(data->tftDisplay, accelValues->zRelPosition, 2);
        printAccelValues_Helper(data->tftDisplay, accelValues->totalDistance, 3);
        printAccelValues_Helper(data->tftDisplay, accelValues->xstaticAngle, 4);
        printAccelValues_Helper(data->tftDisplay, accelValues->ystaticAngle, 5);
        printAccelValues_Helper(data->tftDisplay, accelValues->zstaticAngle, 6);
